...
knownArtifactTypes.zip = knownArtifactTypes.archive;
    ...
    async.series([
      ...
      function(done) {
        const definitions = prettify(_.template(definitionsTpl)({
          spec: csarSpec,
          artifactTypes: _.uniqBy(_.toArray(knownArtifactTypes), (type) => { return type.name + type.namespace }),
          relationshipTypes: _.uniqBy(_.toArray(knownRelationshipTypes), (type) => { return type.name + type.namespace })
        }), {
          indent: 2
        });
